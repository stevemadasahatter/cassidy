...
/usr/sbin/lpadmin -p receipt2 -E -v  lpd://192.168.1.110:515/PASSTHRU -m tm-m30-rastertotmt.ppd  -L "Shopfloor" -o printer-is-shared=true
...
/usr/sbin/lpadmin -p barcode -E -v smb://cocorose:user@192.168.1.180/barcode -m drv:///sample.drv/zebra.ppd -L "Backoffice" -o auth-info-required=negotiate
